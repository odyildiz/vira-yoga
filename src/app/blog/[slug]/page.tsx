            ...
            <div className="bg-surface-container-low border border-surface-dim rounded-2xl p-8 md:p-10 text-center mb-16">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a
                  ...
                  id="blog-detail-whatsapp-cta"
                  className="inline-flex items-center justify-center gap-2 bg-primary text-white font-button px-6 py-3 rounded-full hover:bg-surface-tint transition-colors shadow-[0_4px_14px_rgba(249,115,22,0.3)]"
                >
                ...
                <a
                  ...
                  id="blog-detail-call-cta"
                  className="inline-flex items-center justify-center gap-2 bg-surface text-on-background border border-outline-variant font-button px-6 py-3 rounded-full hover:bg-surface-container transition-colors"
                >
