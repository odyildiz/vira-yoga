    ...
    >
      ...
      <div className="flex flex-col gap-3 w-full mt-auto">
        <Link
          ...
          className={`w-full text-center font-button text-button px-6 py-3 rounded-full transition-colors duration-300 flex items-center justify-center gap-2 ${
            isHighlighted
        ...
        <Link
          ...
          target="_blank"
          className="w-full text-center font-button text-button px-6 py-3 rounded-full border border-[#25D366] text-[#25D366] hover:bg-[#25D366]/5 transition-colors duration-300 flex items-center justify-center gap-2"
        >
