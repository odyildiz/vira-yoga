                ...
                <div className="space-y-4">
                  {filteredSchedule.map((item) => (
                    ...
                    >
                      ...
                      {/* Actions Column */}
                      <div className="w-full md:w-auto flex flex-row flex-wrap justify-end gap-3 md:pl-4 border-t md:border-t-0 border-surface-dim pt-4 md:pt-0 items-center">
                        <button
                        ...
                        <Link
                          ...
                          className="flex-1 md:flex-none text-center bg-primary text-on-primary font-button text-sm px-4 py-2 rounded-full hover:bg-surface-tint transition-colors flex items-center justify-center gap-1 shadow-sm"
                        >
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col gap-3">
                <Link
                  href={`https://wa.me/905551234567?text=${encodeURIComponent(`Merhaba, ${selectedClass.name} dersi hakkında bilgi almak istiyorum.`)}`}
                  target="_blank"
                  className="w-full text-center font-button text-sm px-6 py-3 rounded-full border border-[#25D366] text-[#25D366] hover:bg-[#25D366]/5 transition-colors flex items-center justify-center gap-2"
                >
                ...
                <Link
                  href="tel:+905551234567"
                  className="w-full text-center bg-primary text-on-primary font-button text-sm px-6 py-3 rounded-full hover:bg-surface-tint transition-colors flex items-center justify-center gap-2"
                >
